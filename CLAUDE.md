...
프론트엔드 컨벤션 (IME 처리, 입력 패턴, 화면 전환, 키보드 단축키, 검색 모달, HomeScreen, AllChatsScreen, ProjectsScreen, Sidebar, 즐겨찾기, CodeBlock, MessageBubble, 메시지 재생성, 낙관적 업데이트): [docs/CONVENTIONS.md](docs/CONVENTIONS.md)
